...
source /home/michael/.oh-my-zsh/oh-my-zsh.sh
...
neofetch --colors  1 4 3 1 7 5 2 | lolcat
...
alias runarchsec="docker run -tid --rm --name=archsec --network=host -v $HOME/htb-solutions:/root/htb archsec"
